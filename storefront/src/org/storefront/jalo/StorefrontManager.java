...
/**
 * This is the extension manager of the Storefront extension.
 */
public class StorefrontManager extends GeneratedStorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(StorefrontManager.class.getName());
	 ...
	 */
	public static StorefrontManager getInstance()
	{
		return (StorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				StorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public StorefrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of StorefrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of StorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of StorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
